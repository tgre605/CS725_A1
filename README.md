...
## Table of Contents
 ...
 2. [List of Components](#list-of-components)
    1. [TCPServer](#sftpserver)
    2. [TCPClient](#sftpclient)
    3. [Authentication File](#authentication-file)
    4. [FTP Folder](#ftp-folder-ftp)
3. [How to setup TCPServer and run](#how-to-setup-TCPServer-and-run)
4. [How to setup TCPClient and run](#how-to-setup-TCPSlient-and-run)
